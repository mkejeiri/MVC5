        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    UserManager.AddClaim(user.Id, new Claim(ClaimTypes.Country, "BE"));
                    UserManager.AddClaim(user.Id, new Claim(ClaimTypes.Gender, "Male"));
                    UserManager.AddToRoles(user.Id, new string[] {"Admin", "Moderator", "Owner"});
